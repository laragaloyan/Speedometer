...
public class Speedometer extends View {
    ...
    // drawing colors
    private int ON_COLOR = Color.YELLOW;
    private int OFF_COLOR = Color.GRAY;
    private int SCALE_COLOR = Color.WHITE;
    ...
    public void onDraw(Canvas canvas){
        ...
        drawScale(canvas);
        drawNumbersOnArc(canvas);
        drawReading(canvas);
    }
//draw the segment off state
    ...
    private void drawNumbersOnArc(Canvas canvas){
        ...
        for(int i = 0; i < this.mMaxSpeed; i += increments){
            ...
            canvas.drawTextOnPath(String.format("%d", i), circle, (float) (i*halfCircumference/this.mMaxSpeed), -30f, scalePaint);
        }
